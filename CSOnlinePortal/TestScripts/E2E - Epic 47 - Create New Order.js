...
describe('Create New order - CS Lawyer Portal', function() {



    it('Access CS Lawyer Portal - Create New Deal', function() {
    ...
    it('Access CS Lawyer Portal - Verify Left menu item for Law clark', function() {
